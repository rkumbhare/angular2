...
import com.rkumbhare.angularapp.vo.Error;
import com.rkumbhare.angularapp.vo.User;
...
public class UserController {
	...
	public ResponseEntity<Error> exceptionHandler(Exception e){
		com.rkumbhare.angularapp.vo.Error error = new Error(e.getMessage(), e.toString(), HttpStatus.BAD_REQUEST);
