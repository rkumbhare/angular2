...
var ProductFilterPipe = (function () {
    ...
    ProductFilterPipe.prototype.transform = function (value, arg) {
        //console.log("ProductFilterPipe is executing " + arg);
        if (arg) {
            arg = arg.toLocaleLowerCase();
            return value.filter(function (product) { return product.productName.toLocaleLowerCase().indexOf(arg) != -1; });
        }
        return value;
    };
